...
const BIN_ID = "6a9ac0bdf5f4af5e296a0ae1"; // Your JSONBin ID
const API_KEY = "$2a$10$M/z2e.cKX1SUsOT62D4pk.gbhiuJhRx0u3VzNAe.DsTPIHHAQE6Zu"; // Your API key
const headers = {
...
const ProductDetail: React.FC = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      const productData = response.data.record.find(
        ...
        {isModalOpen && (
          <div className="fixed inset-0 flex justify-center items-center bg-gray-500 bg-opacity-70 z-50">
            <div className="bg-white p-8 rounded-lg mt-9 shadow-lg max-w-lg w-[80%] h-[500px] text-center">
              <h2 className="text-2xl font-semibold text-gray-800 mb-4 font-riss">
