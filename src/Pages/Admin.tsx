...
const BIN_ID = "6a9ac0bdf5f4af5e296a0ae1";
...
export default function AdminPage() {
  ...
  const updateProducts = async (updated: Product[]) => {
    await axios.put(`https://api.jsonbin.io/v3/b/${BIN_ID}`, updated, {
      headers,
    });
    fetchProducts();
  };
    ...
    <>
      <div className="p-6 max-w-5xl mx-auto">
        ...
        <form
          ...
          className="space-y-4 border p-4 rounded-lg bg-white shadow mb-10"
        >
